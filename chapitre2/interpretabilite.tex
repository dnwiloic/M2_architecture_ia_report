% Chapitre 2 : Explicabilité des modèles (inclus depuis main.tex)
\section{Explicabilité des modèles}
...
% -----------------------------------------------------------------------------
\subsection{Définition de l’explicabilité}
...
\subsubsection{Formulation conceptuelle}
...
\subsubsection{Positionnement systémique}
...
% -----------------------------------------------------------------------------
\subsection{Interprétabilité vs explicabilité}
...
\subsubsection{Différence structurelle fondamentale}
...
\subsubsection{Typologie formelle des modèles}
...
\subsubsection{Conséquence scientifique majeure}
...
% -----------------------------------------------------------------------------
\subsection{Méthodes d’explicabilité}
...
\subsubsection{Modèles intrinsèquement interprétables}
...
\subsubsection{Méthodes post-hoc}
...
% -----------------------------------------------------------------------------
\subsection{Explicabilité locale vs globale}
...
\subsubsection{Explicabilité locale}
...
\subsubsection{Explicabilité globale}
...
\subsubsection{Différences structurelles}
...
% -----------------------------------------------------------------------------
\subsection{Conclusion — Importance décisionnelle, enjeux éthiques et réglementaires}
